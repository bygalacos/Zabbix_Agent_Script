...
if ($env:PROCESSOR_ARCHITECTURE -eq "AMD64") {
    ...
    $zipUrl = "https://cdn.zabbix.com/zabbix/binaries/stable/6.4/6.4.10/zabbix_agent-6.4.10-windows-amd64.zip"
} 
elseif ($env:PROCESSOR_ARCHITECTURE -eq "x86") {
    Write-Host "`n[Zabbix Agent] Detected System Architecture: x86`n"
    $zipUrl = "https://cdn.zabbix.com/zabbix/binaries/stable/6.4/6.4.10/zabbix_agent-6.4.10-windows-i386.zip"
}
else {
